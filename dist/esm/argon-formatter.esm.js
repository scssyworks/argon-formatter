...
function format(value, options) {
  ...
  let localeFormat = Object.assign({}, defaultLocaleFormat,
    localeFormats_1[language] || {},
    localeFormats_1[language + '-' + region] || {});
...
function unformat(value, options) {
  ...
  const localeFormat = localeFormats_1[options.locale] || defaultLocaleFormat;
...
let currencies$1 = function () {
  return Object.keys(currencies_1).map(function (key) {
    return currencies_1[key];
  });
};

export { currencies$1 as currencies, defaultCurrency, findCurrency, format, localeCurrency, unformat };
